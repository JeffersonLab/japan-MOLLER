...
if(DEFINED ENV{ET})
  find_library(
    ET_LIBRARY et
    PATHS $ENV{ET}/${arch}/lib $ENV{ETINSTALL}/${CMAKE_SYSTEM_NAME}/lib
...
elseif(DEFINED ENV{CODA})
  find_library(
    ET_LIBRARY et
    PATHS $ENV{CODA}/${arch}/lib $ENV{CODA}/${CMAKE_SYSTEM_NAME}/lib
    DOC "Event Transport (ET) library")
  find_path(
    ET_INCLUDE_DIR
    NAMES et.h
...
if(NOT TARGET EVIO::ET
   AND ET_LIBRARY
   AND ET_INCLUDE_DIR)
  add_library(EVIO::ET SHARED IMPORTED)
  set_target_properties(
    EVIO::ET PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${ET_INCLUDE_DIR}"
