# Fetch EVIO archive (currently from our GitHub mirror) and prepare for building
# the C-library
...
execute_process(COMMAND ${CMAKE_COMMAND} -E make_directory ${EVIO_SOURCE_DIR}
                        ${EVIO_BINARY_DIR})
set(EVIO_TARFILE ${EVIO_SOURCE_DIR}/${tarfile})
file(
  DOWNLOAD https://github.com/${acct}/${repo}/archive/${tarfile} ${EVIO_TARFILE}
...
# This command is system dependent. It requires GNU tar or macOS BSD tar in
# PATH. cmake -E tar does not support --strip-components and extracting a
# filename glob.
find_program(
  TARPROG
  NAMES tar gtar
  DOC "Unix tar archive utility")
if(NOT TARPROG)
...
execute_process(
  COMMAND ${TARPROG} -x --strip-components=3 -f ${EVIO_TARFILE} ${TAR_FLAGS}
          "*/libsrc" WORKING_DIRECTORY ${EVIO_SOURCE_DIR})
# Configure custom CMake files for building the EVIO C-library only
configure_file(CMakeLists.txt.in ${EVIO_SOURCE_DIR}/CMakeLists.txt @ONLY)
file(COPY EVIOConfig.cmake.in DESTINATION ${EVIO_SOURCE_DIR})
