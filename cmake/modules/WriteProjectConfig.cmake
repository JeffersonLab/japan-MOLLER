...
# ----------------------------------------------------------------------------
# Generate project configuration and targets files. Do this only for the main
# project, though, not for submodules since their targets are included in the
...
if("${CMAKE_PROJECT_NAME}" STREQUAL "${PROJECT_NAME}")
  ...
  foreach(cmd IN LISTS commands)
    if(NOT FIND_DEPENDENCY_COMMANDS)
      ...
      set(FIND_DEPENDENCY_COMMANDS "${FIND_DEPENDENCY_COMMANDS}\n${cmd}")
    endif()
  endforeach()
  ...
  configure_package_config_file(
    ...
    PATH_VARS INSTALL_CONFIGDIR CMAKE_INSTALL_PREFIX CMAKE_INSTALL_INCLUDEDIR
              TARGETS_FILE)
